...
import type { Archetype, LikertOption } from './types';
...
// This type is used by geminiService to ensure it's working with the literal goal strings.
export type ArchetypeGoal = typeof ARCHETYPES[number]['goal'];
...
export const SURVEY_QUESTIONS: Record<string, string[]> = {
  ...
  capability_enhancer: [ // AI Intentional Adopter
  ...
  process_integrator: [ // AI Integrator
  ...
  organizational_transformer: [ // AI Advocate
  ...
  foundational_innovator: [ // AI Expert
