...
const SurveyResult = ({ averageScore, archetypeName, onRestart }) => {
    return (<div className="text-center py-6 px-4 bg-slate-700/50 border border-slate-600 rounded-xl shadow-xl">
