...
unitInformationPanel.find(".UnitWidget > div:not(.UnitOutline)").hide();
unitInformationPanel.find(".d2l-widget-content-padding").removeClass("d2l-widget-content-padding");
