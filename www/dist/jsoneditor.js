  ...
  preBuild: function() {
    ...
    // Dynamic Enum
      ...
      for(i=0; i<this.enumSource.length; i++) {
        ...
        /* lfwells hacking away, this should be null in my use case but isn't?
        if(this.enumSource[i].filter) {
          console.log("zz", this.enumSource[i].filter);
    ...
    if(this.enumSource) {
      ...
      for(var i=0; i<this.enumSource.length; i++) {
        ...
        // A watched field
          ...
          // Filter the items
          /* lfwells hacking away, this shoul have been null for me
          if(this.enumSource[i].filter) {
            var new_items = [];
            for(j=0; j<items.length; j++) {
