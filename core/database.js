...
export const applicationInteractionsCollection = db.collection("application_interactions");
export async function init_db(){

  //let customQuery = await db.collection("guilds/987158529569853480/progress").where("studentID", "==", "637398").get();
  //AND
  /*
  let customQuery = await db.collection("guilds/987158529569853480/section_progress").where("studentID", "==", "637398").get();
  const batch = db.batch();
  customQuery.forEach(doc => {
