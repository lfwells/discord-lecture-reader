...
export const SEMESTERS = {  //breaks are inclusive (so first day of break, and the last day of break -- NOT the first day back after break)
    ...
    sem1_2025:{ start: moment("2025-02-24"), breakStart: moment("2025-04-17"), breakEnd: moment("2025-04-23") },
    sem2_2025:{ start: moment("2025-07-21"), breakStart: moment("2025-09-01"), breakEnd: moment("2025-09-07") },
    sem1_2026:{ start: moment("2026-02-23"), breakStart: moment("2026-04-02"), breakEnd: moment("2026-04-08"), weeks: 12 },
    sem2_2026:{ start: moment("2026-07-06"), breakStart: moment("2026-08-24"), breakEnd: moment("2026-08-30"), weeks: 12 },
}
