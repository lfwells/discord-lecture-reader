...
export default async function(client)
{
    ...
    client.on("guildMemberAdd", async function(newMember) {
        ...
        if (hasFeature(newMember.guild, "dm_intro"))
        {
            ...
            newMember.send(`I now feature a "profile" page, where you can track your achievements and stats across all your UTAS Discord Units. You can view it here: https://utasbot.dev/profile/${newMember.id}`);
